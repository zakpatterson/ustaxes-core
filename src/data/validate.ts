...
// The schema generated by AJV for date types will actually be a string representing
// the date time format. When it is stored in the Information interface we need 
// to refer to it as a string and then do the conversion back to Date type when
// working with them in form F8889
export const healthSavingsAccount = ajv.getSchema<types.HealthSavingsAccount<Date>>(
